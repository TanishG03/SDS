...
\begin{equation}
  ...
  \label{eq:entropy}
\end{equation}
computed over the intensity histogram of the tile. Low entropy ($H < 1.0$) characterizes visually flat, featureless regions. High entropy ($H > 2.5$) characterizes informationally dense regions with high structural variation.
...
\begin{thebibliography}{00}
  \bibitem{zhang2022whilbert} Y. Zhang, J. Liu, and X. Wang, ``W-Hilbert: An improved space-filling curve for spatial locality preservation in geospatial indexing,'' IEEE Access, vol. 10, pp. 118234--118247, 2022.
  \bibitem{li2021quadtree} H. Li, Z. Chen, and Y. Zhou, ``Quadtree-guided semantic segmentation for high-resolution remote sensing imagery,'' Remote Sensing, vol. 13, no. 21, Art. no. 4372, 2021.
  \bibitem{rosso2020texture} O. A. Rosso, S. Blanco, and H. A. Larrondo, ``Fractal and texture-based descriptors for spatial pattern analysis in geospatial imagery,'' Pattern Recognition Letters, vol. 135, pp. 119--126, 2020.
\end{thebibliography}
